export function initPropertyCard({
    ...
    properties.forEach((property, index) => {
        ...
        card.innerHTML = `
            <div class="relative">
                ${badgeHTML}
                <img src="${imageSrc}" alt="${property.title}" class="w-full h-[${imageHeight}] object-cover group-hover:scale-105 transition-transform duration-500" onerror="this.src='https://via.placeholder.com/600x400?text=No+Image'">
                ${photoBadge}
